<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SC_PendientesCobranzas.aspx.cs" Inherits="SintecromNet.Paginas.SC_PendientesCobranzas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Pendientes Cobranzas<asp:ScriptManager ID="ScriptManager1" runat="server">
        </asp:ScriptManager>
    </h2>
    <br />
    <asp:Label ID="Label1" runat="server" ForeColor="Maroon" 
        style="text-align: left"></asp:Label>
<asp:GridView ID="gwPendientesCobranzas" runat="server" AutoGenerateColumns="False" 
        Width="900px" onrowdatabound="gwPendientesCobranzas_RowDataBound" 
        ShowFooter="True">
        <Columns>
