...
{
    public partial class VT_FacturacionCotizacionDolar : System.Web.UI.Page
    {
        ...
        private void LlenoGrilla(GridView unGrid, string nombreStored)
        {
        ...
        {
            this.LlenoGrilla(gwGrilla, "dbo.SP_FacturacionDolares");

        }

        protected void btnExcel_Click1(object sender, ImageClickEventArgs e)
        {
            string nombre = "Facturacion" + DateTime.Now.ToShortDateString();
