...
{
    public partial class MAN_Administracion_Incidentes : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (usuario == "wcrozza" || usuario == "mgonzalez" || usuario == "jarroyo")
                {
                    Session["Accede"] = "OK";
                }
        ...
        private void LimpioCampos()
        {
            ...
            imgBorrar.Visible = false;
            txtComentario.Text = "";
            ddAsignar.SelectedValue = "Mantenimiento";
        ...
        protected void ButtonVer_Click(object sender, EventArgs e)
        {
            ...
            this.TraerIncidentes(gwIncidentes, "dbo.SP_Traer_IncidentesM");
        ...
        protected void imgBorrar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    unAcceso.EjecutarSentencia_NonQuery("exec dbo.SP_EliminarIncidentesM " + Convert.ToInt32(Session["NumeroIncidente"]));
        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Session["Accion"].ToString() == "A")
                {
                    ...
                    unAcceso.EjecutarSentencia_NonQuery("exec dbo.SP_InsertarIncidentesAdminM '" + txtComentario.Text +
                                                                                               "','" + lblFecha.Text +
                ...
                else
                {
                    if (Session["Accion"].ToString() == "M")
                    {
                        unAcceso.EjecutarSentencia_NonQuery("exec dbo.SP_EditarIncidentesAdminM '" + txtComentario.Text +
        ...
        {
            string str;
            str = "window.open('MAN_Imagenes.aspx','Titulo','width=500,height=500,sc rollbars=no,resizable=no')";
        ...
        private void ChequeoImagen()
        {
            ...
            try
            {
                ...
                unAcceso.AbrirConexion();
                unDs = unAcceso.ExecuteDataSet(new SqlCommand("dbo.SP_Traer_ImagenM"), unosParametros);
        ...
        private void TraerAsignados()
        {
            ...
            try
            {
                ...
                unAcceso.AbrirConexion();
                unDs = unAcceso.ExecuteDataSet(new SqlCommand("dbo.SP_TraeIncidentesAsignadosM"));

                if (!String.IsNullOrEmpty((unDs.Tables[0].Rows[0]["asignados"]).ToString()))
                {
        ...
        private void TraerDemoraAsignados()
        {
            ...
            try
            {
                ...
                unAcceso.AbrirConexion();
                unDs = unAcceso.ExecuteDataSet(new SqlCommand("dbo.SP_TraeDemoraIncidentesAsignadosM"));


                if (!String.IsNullOrEmpty((unDs.Tables[0].Rows[0]["diferencia"]).ToString()))
                {
        ...
        private void TraerDemoraCerrados()
        {
            ...
            try
            {
                ...
                unAcceso.AbrirConexion();
                unDs = unAcceso.ExecuteDataSet(new SqlCommand("dbo.SP_TraeDemoraIncidentesCerradosM"));
        ...
        private void TraerPorcentual()
        {
            ...
            try
            {
                ...
                unAcceso.AbrirConexion();
                unDs = unAcceso.ExecuteDataSet(new SqlCommand("dbo.SP_TraeIncidentesPorcentualM"));

                if (!String.IsNullOrEmpty((unDs.Tables[0].Rows[0]["mes"]).ToString()))
                {
        ...
        private void TraerAbiertos()
        {
            ...
            try
            {
                ...
                unAcceso.AbrirConexion();
                unDs = unAcceso.ExecuteDataSet(new SqlCommand("dbo.SP_TraeIncidentesAbiertosM"));

                if (!String.IsNullOrEmpty((unDs.Tables[0].Rows[0]["abiertos"]).ToString()))
                 {
