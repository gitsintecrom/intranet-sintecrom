<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PROD_ConsultaNovedadesTurnos.aspx.cs" Inherits="SintecromNet.Paginas.PROD_ConsultaNovedadesTurnos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Consulta Novedades Turnos Producción<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
