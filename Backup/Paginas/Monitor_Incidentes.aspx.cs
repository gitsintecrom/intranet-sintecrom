...
{
    public partial class Monitor_Incidentes : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    this.TraerIncidentes(gwIncidentes, "dbo.SP_Traer_Incidentes_Monitor");
        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                unAcceso.EjecutarSentencia_NonQuery("exec dbo.SP_EditarAsignacion " + Convert.ToInt32(Session["NumeroIncidente"]) +                                                       
