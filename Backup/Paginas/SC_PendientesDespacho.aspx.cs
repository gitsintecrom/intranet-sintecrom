...
{
    public partial class SC_PendientesDespacho : System.Web.UI.Page
    {        
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.TraerPendientesDespacho("dbo.SP_I_TraerPendientesDespacho");
            this.TraerPendientesDespachoGrilla("dbo.SP_TraerPendientesDespacho");
        ...
        private void TraerPendientesDespacho(string nombreStored)
        {
        ...
        private void TraerPendientesDespachoGrilla(string nombreStored)
        {
            ...
            try
            {
                ...
                gwPendientesDespacho.DataSource = unDS;
                gwPendientesDespacho.DataBind();
        ...
        protected void gwPendientesDespacho_RowDataBound(object sender, GridViewRowEventArgs e)
        {
