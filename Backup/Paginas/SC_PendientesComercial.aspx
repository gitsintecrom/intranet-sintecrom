<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SC_PendientesComercial.aspx.cs" Inherits="SintecromNet.Paginas.SC_PendientesComercial" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Pendientes Comercial<asp:ScriptManager ID="ScriptManager1" runat="server">
        </asp:ScriptManager>
    </h2>
    <br />
    <asp:Label ID="Label1" runat="server" ForeColor="Maroon" 
        style="text-align: left"></asp:Label>
<asp:GridView ID="gwPendientesComercial" runat="server" AutoGenerateColumns="False" 
        Width="900px" onrowdatabound="gwPendientesComercial_RowDataBound" 
        ShowFooter="True">
        <Columns>
