<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MAN_Administracion_Incidentes.aspx.cs" Inherits="SintecromNet.Paginas.MAN_Administracion_Incidentes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Administración de incidentes de Mantenimiento<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <table style="margin-left: 12px" __designer:mapid="132">
            ...
            <tr __designer:mapid="133">
                ...
                <asp:DropDownList ID="DropDownList4" runat="server" Width="100px" TabIndex="30">
                    ...
                    <asp:ListItem>Edilicio</asp:ListItem>
                </asp:DropDownList>
                    </td>
        ...
        <tr>
            <td __designer:mapid="134" align="left" class="style23">
                ...
                <asp:DropDownList ID="DropDownList1" runat="server" Width="180px" TabIndex="10" 
                    ...
                    <asp:ListItem Value="Electrico">Electrico</asp:ListItem>
                    <asp:ListItem Value="Electronico">Electronico</asp:ListItem>
                    <asp:ListItem>Edilicios</asp:ListItem>
                </asp:DropDownList>
            </td>
            <td __designer:mapid="135" align="left" class="style21" width="400">
                &nbsp;</td>
