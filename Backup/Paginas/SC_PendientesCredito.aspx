<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SC_PendientesCredito.aspx.cs" Inherits="SintecromNet.Paginas.SC_PendientesCredito" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Pendientes Credito<asp:ScriptManager ID="ScriptManager1" runat="server">
        </asp:ScriptManager>
    </h2>
    <br />
    <asp:Label ID="Label1" runat="server" ForeColor="Maroon" 
        style="text-align: left"></asp:Label>
<asp:GridView ID="gwPendientesCredito" runat="server" AutoGenerateColumns="False" 
        Width="900px" onrowdatabound="gwPendientesCredito_RowDataBound" 
        ShowFooter="True">
        <Columns>
    ...
    <asp:Label ID="Label2" runat="server" ForeColor="Maroon" 
        style="text-align: left"></asp:Label>
<asp:GridView ID="gwPendientesCredito0" runat="server" AutoGenerateColumns="False" 
        Width="900px" onrowdatabound="gwPendientesCredito0_RowDataBound" 
        ShowFooter="True">
        <Columns>
            <asp:BoundField DataField="Cliente" HeaderText="Cliente" >
            <ControlStyle Width="5%" />
