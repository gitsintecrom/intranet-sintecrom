<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VT_ParteDiario.aspx.cs" Inherits="SintecromNet.Paginas.VT_ParteDiario" %>
...
<asp:ImageButton ID="btnExcel0" runat="server" Height="51px" 
...
<asp:ImageButton ID="btnExcel1" runat="server" Height="51px" 
...
<asp:ImageButton ID="btnExcel2" runat="server" Height="51px" 
