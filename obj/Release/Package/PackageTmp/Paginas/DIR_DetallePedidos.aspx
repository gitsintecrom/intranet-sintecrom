<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DIR_DetallePedidos.aspx.cs" Inherits="SintecromNet.Paginas.DIR_DetallePedidos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <h2>Pedidos <asp:Label ID="lblTitulo" runat="server"></asp:Label></h2>
           ...
           <asp:Chart ID="Chart1" runat="server" Width="420px" BackColor="0, 51, 102" 
            ...
            <Titles>
                <asp:Title BackColor="#003366" ForeColor="White" Name="Title1" 
                    Text="Pedidos Por Familia Dolares">
                </asp:Title>
            </Titles>
        </asp:Chart>
    &nbsp;
            ...
            <Titles>
                <asp:Title BackColor="#003366" ForeColor="White" Name="Title1" 
                    Text="Pedidos Por Familia Kilos">
                </asp:Title>
            </Titles>
        </asp:Chart>
                        <br />
        ...
        <asp:Chart ID="Chart2" runat="server" Width="844px" BackColor="0, 51, 102" 
            ...
            <Titles>
                <asp:Title BackColor="#003366" ForeColor="White" Name="Title1" 
                    Text="Pedidos por Vendedor en Dolares">
                </asp:Title>
            </Titles>
        </asp:Chart>
    <br />
        ...
        <div class="panel panel-primary">
            <div class="panel-heading"><h4>Detalle Pedidos</h4></div>
                ...
                <div class="panel-body">                
                    ...
                    <%--<HeaderStyle BackColor="#337ab7" Font-Bold="True" ForeColor="White" />--%>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="FechaActual" HeaderText="Fecha" DataFormatString="{0:dd/MM/yyyy}">
                            <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="Total_Importe" HeaderText="Dolares" DataFormatString="{0:0.00}">
                            <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>                            
                        </Columns>                      
                    </asp:GridView>
