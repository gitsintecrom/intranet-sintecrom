<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DIR_ReclamosPendientes.aspx.cs" Inherits="SintecromNet.Paginas.DIR_ReclamosPendientes" %>
     ...
     <%--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--%>
        ...
        <br />
                <asp:GridView ID="gwGrilla" CssClass="table table-striped table-bordered table-hover" runat="server"  AutoGenerateColumns="False"      
                    EmptyDataText="No se Encontraron Datos" DataKeyNames="ID,Contacto,Motivo,Emite,Observaciones,ReclamoExterno,Cliente" 
    ...
    ForeColor="#999999" >
        ...
        <div class="input-group">
            ...
            <br />
             <br />
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             <asp:Button ID="btnEjecutar" runat="server" BorderStyle="None" class="btn btn-success btn-circle" OnClick="btnEjecutar_Click" onclientclick="return estaseguro()" Text="Aprobar" width="130" />
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             <asp:Button ID="Button1" runat="server" BackColor="#CC3300" BorderStyle="None" class="btn btn-success btn-circle" OnClick="Button1_Click1" onclientclick="return estaseguro()" Text="Rechazar" width="130" />
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button6" runat="server" class="btn btn-success btn-circle" width="130" onclick="Button2_Click1" 
                Text="Cerrar" TabIndex="170" BackColor="#669999" BorderStyle="None" />
