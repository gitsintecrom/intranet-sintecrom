<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="INV_EgresoInventario.aspx.cs" Inherits="SintecromNet.Paginas.INV_EgresoInventario" %>
    ...
    <div class="jumbotron">
        ...
        <br />
            <div class="input-group">
                ...
                <asp:Label ID="Label1" runat="server"  CssClass="form-control" BackColor="#337AB7" ForeColor="White" style="text-align: left" Text="Cantidad:" Width="140px"></asp:Label>
