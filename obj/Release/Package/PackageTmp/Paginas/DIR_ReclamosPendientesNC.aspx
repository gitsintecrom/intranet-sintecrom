<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DIR_ReclamosPendientesNC.aspx.cs" Inherits="SintecromNet.Paginas.DIR_ReclamosPendientesNC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <div class="jumbotron">
    <h2>Autorización Envío Reclamos</h2>
...
<ControlStyle CssClass="btn btn-info"></ControlStyle>
            ...
            <asp:ButtonField ButtonType="Button" CommandName="Gestion" HeaderText="Ver Gestión"  ControlStyle-CssClass="btn btn-warning" Text="Ver Gestión" >
<ControlStyle CssClass="btn btn-warning"></ControlStyle>
            </asp:ButtonField>
            <asp:ButtonField ButtonType="Button" CommandName="Respuesta" HeaderText="Ver Respuesta"  ControlStyle-CssClass="btn btn-primary" Text="Ver Respuesta" >
<ControlStyle CssClass="btn btn-primary"></ControlStyle>
            </asp:ButtonField>
            <asp:ButtonField ButtonType="Button" CommandName="Envio" HeaderText="Ver Informe"  ControlStyle-CssClass="btn btn-success" Text="Ver Informe" >

<ControlStyle CssClass="btn btn-success" BackColor="#CC99FF" BorderStyle="None"></ControlStyle>
            </asp:ButtonField>
            

            <asp:ButtonField CommandName="Aprobar"  
                HeaderText="Aprobar" ButtonType="Button" ControlStyle-CssClass="btn btn-danger" ControlStyle-BorderStyle="None" Text="Aprobar" >            
                <ControlStyle BorderStyle="None" CssClass="btn btn-success"></ControlStyle>
            </asp:ButtonField>

            <asp:ButtonField ButtonType="Button" CommandName="Rechazar" HeaderText="Rechazar"  ControlStyle-CssClass="btn btn-danger" Text="Rechazar" >

<ControlStyle CssClass="btn btn-success" BackColor="#CC3300" BorderStyle="None"></ControlStyle>
            </asp:ButtonField>
    ...
    <asp:ModalPopupExtender ID="HiddenFieldError_ModalPopupExtender" runat="server" 
        ...
        <asp:GridView ID="gwAdjuntos" runat="server"  CssClass="table table-striped table-bordered table-hover"  
            ...
            onrowcommand="gwAdjuntos_RowCommand" onselectedindexchanged="gwAdjuntos_SelectedIndexChanged" OnRowDeleting="gwAdjuntos_RowDeleting" EmptyDataText="No existen Adjuntos Para El Reclamo Seleccionado" >
            <Columns>
        ...
        <asp:Panel ID="Panel2" runat="server" BackColor="#CCCCCC" BorderStyle="Outset" BorderWidth="3px" height="400px" Width="660px" CssClass="form-control">
        ...
        <br />
        &nbsp;<asp:Button ID="Button3" runat="server" CssClass="btn btn-danger" TabIndex="170" Text="Cerrar" />
        <br />
    </asp:Panel>
        ...
        <asp:Label ID="Label23" runat="server" Font-Size="Medium" BackColor="#003366" CssClass="form-control" Font-Bold="True" ForeColor="White" style="text-align:center" Width="630px"></asp:Label>
            ...
            <asp:TextBox ID="txtCausa" runat="server" cssclass="form-control" Height="70px" TextMode="MultiLine" Width="550px" ReadOnly="True"></asp:TextBox>
            ...
            <asp:TextBox ID="txtCorreccion" runat="server" cssclass="form-control" Height="70px" TextMode="MultiLine" Width="550px" ReadOnly="True"></asp:TextBox>
            ...
            <asp:TextBox ID="txtKilosAceptados" runat="server" cssclass="form-control" style="text-align: right" Width="150px" ReadOnly="True">0</asp:TextBox>
            <asp:Label ID="Label25" runat="server" BackColor="#337AB7" CssClass="form-control" ForeColor="White" Text="SAC:" Width="150px"></asp:Label>
            <asp:TextBox ID="txtSAC" runat="server" cssclass="form-control"  style="text-align: right" Width="150px" ReadOnly="True">0</asp:TextBox>
        <br />
