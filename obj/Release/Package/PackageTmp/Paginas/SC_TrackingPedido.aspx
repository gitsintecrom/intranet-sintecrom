<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="SC_TrackingPedido.aspx.cs" Inherits="SintecromNet.Paginas.SC_TrackingPedido" %>
    ...
    <h2>Tracking de Pedidos </h2>    
        ...
        <div class="panel panel-primary">
            <div class="panel-heading"><h4>Filtros</h4></div>
                ...
                <asp:Label ID="Label2" runat="server" CssClass="form-control" BackColor="#337AB7" ForeColor="White" style="text-align: left" Text="Cliente:" Width="100px"></asp:Label>
                <asp:TextBox ID="txtCliente" runat="server" CssClass="form-control" Width="200px"></asp:TextBox>
                &nbsp; <asp:Label ID="lblPedido1" runat="server" CssClass="form-control" BackColor="#337AB7" ForeColor="White" style="text-align: left" Text="Vendedor:" Width="100px"></asp:Label>
                <asp:TextBox ID="txtVendedor" runat="server" CssClass="form-control" Width="200px"></asp:TextBox>
                         <br /><br />
                         <asp:Label ID="lblPedido" runat="server" CssClass="form-control" BackColor="#337AB7" ForeColor="White" style="text-align: left" Text="Pedido:" Width="100px"></asp:Label>
                        <asp:TextBox ID="txtNumeroPedido" runat="server" CssClass="form-control" Width="200px"></asp:TextBox>                
                        <asp:Label ID="lblPedido0" runat="server" CssClass="form-control" BackColor="#337AB7" ForeColor="White" style="text-align: left" Text="Estado:" Width="100px"></asp:Label>
...
<asp:ImageButton ID="btnExcel" runat="server" CssClass="form-control" Height="51px" 
    ...
    ToolTip="Exportar a Excel" Width="53px" Visible="False" ImageAlign="Middle" />
        ...
        CssClass="table table-striped table-bordered table-hover"  
                    ...
                    onselectedindexchanged="gwNoCumplidos_SelectedIndexChanged" DataKeyNames="ID_ITEMPED,EnFabricacion,Fabricado,Entregado,aProgramar,Programado">
        <Columns>
            ...
            <asp:BoundField DataField="Transferido" DataFormatString="{0:0.00}" HeaderText="Transferido" />
              ...
              <asp:ButtonField CommandName="aProgramar"  DataTextField="aProgramar"
                HeaderText="A Programar" ButtonType="Button" ControlStyle-BorderStyle="None" ControlStyle-CssClass="btn btn-primary" DataTextFormatString="{0:0.00}" >            
            </asp:ButtonField>
            <asp:BoundField DataField="Programado" HeaderText="Programado" DataFormatString="{0:0.00}"  />
             <asp:ButtonField CommandName="Arbol" HeaderText="Arbol" ButtonType="Button" ControlStyle-BorderStyle="None" ControlStyle-CssClass="btn btn-primary" Text="Arbol" ControlStyle-BackColor="#993300">            
            </asp:ButtonField>
             <asp:ButtonField CommandName="VerEnFabrica"  DataTextField="EnFabricacion"
                HeaderText="En Fabricación" ButtonType="Button" ControlStyle-CssClass="btn btn-info" ControlStyle-BorderStyle="None" DataTextFormatString="{0:0.00}" >            
            </asp:ButtonField>
            <asp:ButtonField CommandName="Fabricado"  DataTextField="Fabricado"
                HeaderText="Pendiente Despacho" ButtonType="Button" ControlStyle-CssClass="btn btn-warning" ControlStyle-BorderStyle="None" DataTextFormatString="{0:0.00}" >            
            </asp:ButtonField>
        ...
        <Columns>
            ...
            <asp:BoundField   DataField="Fabricado"
                HeaderText="Fabricado" DataFormatString="{0:0.00}" >            
            </asp:BoundField>
   ...
   <asp:Panel ID="Panel1" runat="server" BorderStyle="Outset" BorderWidth="3px" HorizontalAlign="Center" Width="1000px" BackColor="#CCCCCC" style="text-align: center" Visible="False">
       ...
       <br />
        ...
        <asp:Panel ID="Panel4" runat="server" BorderStyle="Outset" BorderWidth="3px" HorizontalAlign="Center" Width="1000px" BackColor="#CCCCCC" style="text-align: center" Visible="False">
            <br />
            <asp:Label ID="Label22" runat="server" Text="Pedido:"></asp:Label>
            <asp:Label ID="Label23" runat="server" Font-Bold="True"></asp:Label>
            <asp:Label ID="Label24" runat="server" Text="Item:"></asp:Label>
            <asp:Label ID="Label25" runat="server" Font-Bold="True"></asp:Label>
            <asp:Label ID="Label26" runat="server" Text="Clon:"></asp:Label>
            <asp:Label ID="Label27" runat="server" Font-Bold="True"></asp:Label>
            <asp:Label ID="Label28" runat="server" Text="Programado:"></asp:Label>
            <asp:Label ID="Label29" runat="server" Font-Bold="True"></asp:Label>
       
       <br />
            <br />
            <asp:CheckBoxList ID="CheckBoxList2" runat="server"  style="top: 24px; left: 35px; text-align:left" BorderStyle="None" Width="300" AutoPostBack="True" OnSelectedIndexChanged="CheckBoxList2_SelectedIndexChanged">
            </asp:CheckBoxList>
              <br />           
            <asp:CheckBoxList ID="CheckBoxList1" runat="server"  style="top: 44px; left: 55px; text-align:left" BorderStyle="None" Width="300" AutoPostBack="True" OnSelectedIndexChanged="CheckBoxList1_SelectedIndexChanged" ForeColor="#009933">
            </asp:CheckBoxList>
            <asp:GridView ID="gwOperaciones" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" EmptyDataText="No se Encontraron Registros para la Selección" style="text-align: center">
                <Columns>
                    <asp:BoundField DataField="Maquina" HeaderText="Maquina" />
                    <asp:BoundField DataField="NroBatch" HeaderText="Batch" />
                    <asp:BoundField DataField="KilosProgramadosEntrantes" HeaderText="Kilos Programados" />
                    <asp:BoundField DataField="kilos_balanza" HeaderText="Kilos Balanza" />
                    <asp:BoundField DataField="Kilos_SobreOrden" HeaderText="SobreOrden" />
                    <asp:BoundField DataField="Kilos_Calidad" HeaderText="Calidad" />
                    <asp:BoundField DataField="Estado" HeaderText="Estado" />
                    <asp:BoundField DataField="Abastecida" HeaderText="Abastecida" />
                    <asp:BoundField DataField="origen_lote_desc" HeaderText="Lote Entrante" />
                    <asp:BoundField DataField="Destino_Lote_Desc" HeaderText="Lote Saliente" />
                </Columns>
                <%--<HeaderStyle BackColor="Maroon" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" />
                <RowStyle Font-Names="Arial" Font-Size="8pt" HorizontalAlign="Center" VerticalAlign="Middle" />--%>
                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Font-Size="12px" />
                <RowStyle HorizontalAlign="Center" VerticalAlign="Middle" Font-Size="10px" />
            </asp:GridView>
            <asp:Button ID="Button5" runat="server"  BorderStyle="None" CssClass="btn btn-success btn-circle" ForeColor="White" Text="Ver Otra Operacion" OnClick="Button5_Click" />
            <asp:Button ID="Button6" runat="server"  BorderStyle="None" CssClass="btn btn-success btn-circle" ForeColor="White" Text="Ver Otro Matching" OnClick="Button6_Click" />
            <br />
            <br /><br /><br />
            <asp:Button ID="Button3" CssClass="btn btn-success btn-circle" BackColor="Red" ForeColor="White" runat="server" OnClick="Button3_Click" Text="Cerrar" BorderStyle="None" />
    </asp:Panel>
