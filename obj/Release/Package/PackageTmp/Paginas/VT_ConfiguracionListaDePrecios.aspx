<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="VT_ConfiguracionListaDePrecios.aspx.cs" Inherits="SintecromNet.Paginas.VT_ConfiguracionListaDePrecios" %>
...
<br />
        ...
        <Columns>
           ...
           <%-- <asp:BoundField DataField="NumeroLista" HeaderText="Numero" />
            ...
            <asp:BoundField DataField="Estado" HeaderText="Estado" />
                     ...
                     <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"/>
                            <RowStyle Font-Names="Arial" HorizontalAlign="Center" VerticalAlign="Middle" Font-Size="7px" />
