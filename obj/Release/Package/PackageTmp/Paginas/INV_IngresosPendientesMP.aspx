<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="INV_IngresosPendientesMP.aspx.cs" Inherits="SintecromNet.Paginas.INV_IngresosPendientesMP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    <h2>Ingresos Pendientes Materia Prima</h2>
    ...
    <div class="jumbotron">
        ...
        <asp:GridView ID="gwGrilla" runat="server" AutoGenerateColumns="False" 
         CssClass="table table-striped table-bordered table-hover"  
                    ...
                    EmptyDataText="No se Encontraron Datos" OnRowCommand="gwGrilla_RowCommand" DataKeyNames="ITEM_ID,Origen,Numero,Proveedor">
        <Columns>
   ...
   <asp:Panel ID="Panel1" runat="server" BorderStyle="Outset" BorderWidth="3px" HorizontalAlign="Center" Width="1000px" BackColor="#CCCCCC" style="text-align: center" Visible="False">
       ...
       <h3>
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Pendiente" HeaderText="Pendiente" DataFormatString="{0:n0}" />
            <asp:BoundField DataField="Original" HeaderText="Original" DataFormatString="{0:n0}" />
            <asp:BoundField DataField="Cancelado" HeaderText="Cancelado" />
            <asp:BoundField DataField="FechaEstimada" DataFormatString="{0:dd/MM/yyyy}" HeaderText="Fecha Estimada" />
        </Columns>
                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"/>
                    <RowStyle Font-Names="Arial" HorizontalAlign="Center" VerticalAlign="Middle" />
