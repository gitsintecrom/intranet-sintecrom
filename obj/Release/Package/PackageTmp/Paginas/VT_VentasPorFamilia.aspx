<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="VT_VentasPorFamilia.aspx.cs" Inherits="SintecromNet.Paginas.VT_VentasPorFamilia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <h2>Ventas Por Familia <asp:Label ID="Label1" runat="server"></asp:Label></h2>

        <div class="panel panel-primary">
            <div class="panel-heading"><h4>Ventas Por Familia</h4></div>
                <div class="panel-body">                
                    <div class="input-group">
   
        <asp:Chart ID="Chart4" runat="server" class="img-responsive"  BackColor="0, 51, 102" 
            BackGradientStyle="Center" Palette="Grayscale" Width="880px" OnClick="Chart4_Click" Height="500px">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading"><h4>Ventas Por Clientes</h4></div>
                <div class="panel-body">                
                    <div class="input-group">
   
        <asp:Chart ID="Chart1" runat="server" class="img-responsive"  BackColor="0, 51, 102" 
            BackGradientStyle="Center" Palette="SeaGreen" Width="880px" OnClick="Chart1_Click" Height="500px">
                      
            <Series>
                <asp:Series ChartArea="ChartArea1" Name="Series1" ToolTip="#VAL{D} #VALX" YValuesPerPoint="2" PostBackValue="#VALX" ChartType="StackedBar">
                </asp:Series>
            </Series>
            ...
            <Titles>
                <asp:Title BackColor="#003366" ForeColor="White" Name="Title1" 
                    Text="Ventas Por Clientes Por Kilos">
                </asp:Title>
            </Titles>
        </asp:Chart>
        ...
        <div class="panel panel-primary">
            <div class="panel-heading"><h4>Ventas <asp:Label ID="lblTitulo" runat="server"></asp:Label></h4></div>
                <div class="panel-body">                
                    <div class="input-group">
                      <br />  
                    ...
                    <%--<HeaderStyle BackColor="#337ab7" Font-Bold="True" ForeColor="White" />--%>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Descripcion" HeaderText="Desc.Producto" />
                            <asp:BoundField DataField="OC_CLIENTE" HeaderText="Orden Compra" />
