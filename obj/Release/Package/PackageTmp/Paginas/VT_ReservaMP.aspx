<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="VT_ReservaMP.aspx.cs" Inherits="SintecromNet.Paginas.VT_ReservaMP" %>
    ...
    <div class="jumbotron">
        ...
        <Columns>
            ...
            <asp:ButtonField CommandName="Detalle"  
                ButtonType="Button" ControlStyle-CssClass="btn btn-success" ControlStyle-BorderStyle="None" Text="Reservar" >            
        ...
        <br />
            <div class="input-group">
                    <asp:Label ID="lblPedido8" runat="server" BackColor="#337AB7" CssClass="form-control" ForeColor="White" Text="Cliente:" Width="150px"></asp:Label>
                    <asp:DropDownList ID="DropDownList3" runat="server" CssClass="form-control" Width="350px">                        
                    </asp:DropDownList>
                <br />
                <br />

                
                    <asp:Label ID="labelRes1" runat="server" BackColor="#337AB7" CssClass="form-control" ForeColor="White" style="text-align: left" Text="Fecha Hasta:" Width="150px"></asp:Label>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBoxFin" CssClass="alert-danger" ErrorMessage="Debe Ingresar una Fecha de Caducidad de la Reserva" ValidationGroup="Aceptar">*</asp:RequiredFieldValidator>

                 <br />

                <br />
                <asp:Label ID="Label2" runat="server"  CssClass="form-control" BackColor="#337AB7" ForeColor="White" style="text-align: left" Text="Detalle:" Width="150px"></asp:Label>
