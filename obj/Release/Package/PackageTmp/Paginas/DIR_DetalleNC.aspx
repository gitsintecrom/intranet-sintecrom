<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DIR_DetalleNC.aspx.cs" Inherits="SintecromNet.Paginas.DIR_DetalleNC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <h2>Notas de Crédito <asp:Label ID="lblTitulo" runat="server"></asp:Label></h2>
                        
        <div class="panel panel-primary">
            <div class="panel-heading"><h4>Detalle Notas de Crédito</h4></div>
