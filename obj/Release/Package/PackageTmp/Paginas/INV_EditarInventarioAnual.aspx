<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="INV_EditarInventarioAnual.aspx.cs" Inherits="SintecromNet.Paginas.INV_EditarInventarioAnual" %>
...
<head id="Head1" runat="server">
    ...
    if (lote.length !=3) {
        ...
        function validaentrada() {
            ...
            if (entrada > 2000) {
                alert("El Numero de Etiqueta no puede ser mayor a 2000");
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <div runat="server" id="Cabecera" visible="false" class="input-group">
               
            <asp:Label ID="Label7" runat="server" BackColor="#337AB7" CssClass="form-control" ForeColor="White" Text="Etiqueta:" Width="100px"></asp:Label>
            <asp:TextBox ID="txtBuscar" runat="server" CssClass="form-control"  Width="100px" TextMode="Number">0</asp:TextBox>
                      
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      
            <asp:Button ID="btnBuscar" CssClass="btn btn-info btn-circle" ForeColor="White" runat="server" OnClick="btnBuscar_Click" Text="Buscar" BorderStyle="None" Width="100" />
            ...
            <div runat="server" id="Ingreso" visible="false" class="input-group">               
                ...
                <br />
                <br />
                <asp:Label ID="Label1" runat="server"  CssClass="form-control" BackColor="#337AB7" ForeColor="White" style="text-align: left; top: 0px; left: 0px;" Text="Cantidad:" Width="100px"></asp:Label>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddFamilia" CssClass="alert-danger" ErrorMessage="Debe Seleccionar una Familia" ValidationGroup="Aceptar">*</asp:RequiredFieldValidator>
            ...
            <br />
                 ...
                 <br />
                   ...
                   <asp:Button ID="btnCerrar0" CssClass="btn btn-success btn-circle" ForeColor="White" runat="server" OnClick="btnCerrar0_Click" Text="Aceptar" BorderStyle="None" Width="150px" ValidationGroup="Aceptar" />
                
                        &nbsp;<asp:Button ID="btnBorrar" CssClass="btn btn-danger btn-circle" ForeColor="White" runat="server" OnClick="btnBorrar_Click" Text="Elilminar" BorderStyle="None" Width="150px" />
      
    
                
              &nbsp;<asp:Button ID="btnBuscarOtra" CssClass="btn btn-info btn-circle" ForeColor="White" runat="server" OnClick="btnBuscarOtra_Click" Text="Buscar" BorderStyle="None" Width="150px" />
