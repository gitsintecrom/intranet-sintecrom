<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="COM_ProductosPañol.aspx.cs" Inherits="SintecromNet.Paginas.COM_ProductosPañol" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <div class="jumbotron">
    <h2 style="background-color:honeydew">Productos Pañol Valorizado 
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <h3>
            <span style="float:left;"><asp:Label ID="lbldola" runat="server" Text="Total Dolares:" CssClass="label label-primary"  /></span>                
            <span style="float:left;"><asp:Label ID="lbltotald" runat="server" Text="" CssClass="label label-success"  /></span>

            <span style="float:left;"><asp:Label ID="Label1" runat="server" Text="Total Pesos:" CssClass="label label-primary"  /></span>                
            <span style="float:left;"><asp:Label ID="lbltotalp" runat="server" Text="" CssClass="label label-info"  /></span>
                </h3>
        ...
        <br />--%>
                ...
                <asp:GridView ID="gwGrilla" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover"                  
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Moneda" HeaderText="Moneda">
                        <HeaderStyle Width="5%" Font-Size="X-Small" />
                        <ItemStyle  Font-Size="X-Small"/>
                        </asp:BoundField>
                        <asp:BoundField DataField="Valor" DataFormatString="{0:0.00}" HeaderText="Valor">
                        <HeaderStyle Width="5%" />
                        ...
                        <asp:BoundField DataField="ValorIPC" DataFormatString="{0:0.00}" HeaderText="Val.Act." />
                        <asp:BoundField DataField="Cotizacion" DataFormatString="{0:0.00}" HeaderText="Cotiz.">
                        <HeaderStyle Width="4%" />
                        <ItemStyle  Font-Size="X-Small"/>
                        </asp:BoundField>
