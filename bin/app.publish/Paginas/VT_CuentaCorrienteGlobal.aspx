<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="VT_CuentaCorrienteGlobal.aspx.cs" Inherits="SintecromNet.Paginas.VT_CuentaCorrienteGlobal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <h2>Estado Cuenta Corriente </h2>
        ...
        <div class="panel panel-primary">
            ...
            BackGradientStyle="Center" Palette="SeaGreen" Width="420px" Height="400px">
            ...
            <div style="overflow:auto; height: 150px;">
                    ...
                    <%--<HeaderStyle BackColor="#337ab7" Font-Bold="True" ForeColor="White" />--%>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Total" DataFormatString="{0:n0}" HeaderText="Total Pesos" />
                            <asp:BoundField DataField="Vencido" DataFormatString="{0:n0}" HeaderText="Vencido Pesos" />
                            <asp:BoundField DataField="Cliente_ID" HeaderText="Cliente_ID" Visible="False" />
                        </Columns>  
                             <HeaderStyle  BackColor="#337ab7" Font-Bold="True" ForeColor="White"  HorizontalAlign="Center" VerticalAlign="Middle"/>
                          <RowStyle Font-Names="Arial" Font-Size="8pt" HorizontalAlign="Center" VerticalAlign="Middle" />               
            ...
            <div style="overflow:auto; height: 400px;">
                    ...
                    <%--<HeaderStyle BackColor="#337ab7" Font-Bold="True" ForeColor="White" />--%>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Saldo" HeaderText="Total Pesos" DataFormatString="{0:n0}">
                            </asp:BoundField>
                            <asp:BoundField DataField="Vencido" DataFormatString="{0:n0}" HeaderText="Vencida Pesos" />
                        </Columns> 
                             <HeaderStyle  BackColor="#337ab7" Font-Bold="True" ForeColor="White"  HorizontalAlign="Center" VerticalAlign="Middle"/>
