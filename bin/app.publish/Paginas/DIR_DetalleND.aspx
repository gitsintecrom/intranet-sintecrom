<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DIR_DetalleND.aspx.cs" Inherits="SintecromNet.Paginas.DIR_DetalleND" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <h2>Notas de Débito <asp:Label ID="lblTitulo" runat="server"></asp:Label></h2>

        
        
        <div class="panel panel-primary">
            <div class="panel-heading"><h4>Detalle Notas de Débito</h4></div>
