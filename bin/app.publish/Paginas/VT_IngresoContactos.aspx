<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="VT_IngresoContactos.aspx.cs" Inherits="SintecromNet.Paginas.VT_IngresoContactos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <div class="jumbotron">
    <h2>Ingreso Contactos de Potenciales Clientes</h2><asp:ScriptManager ID="ScriptManager1" runat="server">
        </asp:ScriptManager>

        <div class="panel panel-primary">

            <div class="panel-heading"><h4>Nuevo Contacto</h4></div>
            ...
            <asp:TextBox ID="txtContacto" cssclass="form-control" runat="server" Width="300px"></asp:TextBox>   
            ...
            <asp:Label ID="Label8" runat="server" BackColor="#337AB7" CssClass="form-control" ForeColor="White" Text="Dirección:" Width="150px"></asp:Label>
            <asp:TextBox ID="txtDireccion" cssclass="form-control" runat="server" Width="300px"></asp:TextBox>   
            <br />   
            <br /> 
