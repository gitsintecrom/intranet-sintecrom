<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="INV_Reclasificaciones.aspx.cs" Inherits="SintecromNet.Paginas.INV_Reclasificaciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    <h2>Reclasificación de Inventario</h2>
    ...
    <div class="jumbotron">
        ...
        <br />
            <div class="input-group">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtDetalle" ErrorMessage="*" Font-Bold="True" ForeColor="Red" ValidationGroup="Aceptar"></asp:RequiredFieldValidator>
