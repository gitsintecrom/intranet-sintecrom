<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="PROD_IngresoPlanta2.aspx.cs" Inherits="SintecromNet.Paginas.PROD_IngresoPlanta2" %>
...
<asp:ImageButton ID="btnExcel" runat="server" CssClass="form-control"  
    ...
    ToolTip="Exportar a Excel" Width="50px" ImageAlign="Middle" />
            <br />
        ...
        <Columns>
            ...
            <asp:BoundField DataField="DESCRIPPRODUCTO" HeaderText="Desc.Producto" />
            <asp:BoundField DataField="Fecha" HeaderText="Fecha " DataFormatString="{0:dd/MM/yyyy}" >
            <ItemStyle Font-Names="Arial" Font-Size="8pt" HorizontalAlign="Center" VerticalAlign="Middle" />
            </asp:BoundField>
            <asp:BoundField DataField="CANTIDAD" HeaderText="Kilos" DataFormatString="{0:0.00}"></asp:BoundField>
