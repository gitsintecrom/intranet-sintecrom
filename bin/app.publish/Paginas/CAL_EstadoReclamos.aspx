<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="CAL_EstadoReclamos.aspx.cs" Inherits="SintecromNet.Paginas.CAL_EstadoReclamos" %>
    ...
    <div class="panel panel-primary">
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
        ...
        <Columns>
            ...
            <asp:BoundField DataField="NroNC" HeaderText="NC" />
...
<ControlStyle CssClass="btn btn-success"></ControlStyle>
    ...
    <asp:ModalPopupExtender ID="HiddenFieldError_ModalPopupExtender" runat="server" 
        ...
        <asp:Panel ID="Panel2" runat="server" BackColor="#CCCCCC"
             BorderStyle="Outset" BorderWidth="3px" height="660px" Width="660px" style="overflow:auto; height:600px; "
        ...
        Height="800px" Width="600px" style="overflow:auto; height:600px; "
            BorderColor="Black" BorderStyle="Solid" BorderWidth ="1px" 
            BackColor ="WhiteSmoke"  
    ForeColor="#999999" >
