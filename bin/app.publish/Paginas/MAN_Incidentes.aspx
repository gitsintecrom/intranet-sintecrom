<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="MAN_Incidentes.aspx.cs" Inherits="SintecromNet.Paginas.MAN_Incidentes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <h1>Incidentes Mantenimiento</h1>
            ...
            <div class="panel-body">                
              <div class="input-group">
                ...
                <div class="input-group">
                        ...
                        <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" TabIndex="10" Width="250px">
                        ...
                        <br />
                        <br />
                        <asp:Label ID="Label6" runat="server" ForeColor="White" Text="Comentario:" Width="90px" CssClass="form-control" BackColor="#003366"></asp:Label>
