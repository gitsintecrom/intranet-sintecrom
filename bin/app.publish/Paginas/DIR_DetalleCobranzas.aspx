<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DIR_DetalleCobranzas.aspx.cs" Inherits="SintecromNet.Paginas.DIR_DetalleCobranzas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <h2>Evolución Cobranzas <asp:Label ID="lblTitulo" runat="server"></asp:Label></h2>
