<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="CAL_AutorizacionMuestras.aspx.cs" Inherits="SintecromNet.Paginas.CAL_AutorizacionMuestras" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <div class="jumbotron">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="ObservacionesC" HeaderText="ObservacionesC" Visible="False" />
            <asp:BoundField DataField="ObservacionesV" HeaderText="ObservacionesV" Visible="False" />
            <asp:BoundField DataField="ObservacionesP" HeaderText="ObservacionesP" Visible="False" />
   ...
   <asp:Panel ID="Panel1" runat="server"  BorderStyle="Outset" BorderWidth="3px" Width="100%" BackColor="#336699" Visible="False">
       ...
       <div class="input-group">
        ...
        <br /> 
                ...
                <asp:Button ID="btnAutorizar" CssClass="btn btn-success btn-circle"  width="100%" ForeColor="White" runat="server" OnClick="btnAutorizar_Click" Text="Autorizar" BorderStyle="None" />
    
                     <br /> 
                        
                    <asp:Button ID="btnRechazar" runat="server" BackColor="Red"  width="100%" BorderStyle="None" CssClass="btn btn-success btn-circle" ForeColor="White" OnClick="btnRechazar_Click" Text="Rechazar" />
