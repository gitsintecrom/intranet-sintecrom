<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="COM_MateriasPrimasPendientes.aspx.cs" Inherits="SintecromNet.Paginas.COM_MateriasPrimasPendientes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <div class="jumbotron">
      ...
      <div class="panel panel-primary">
            <div class="panel-heading"><h4>Pendiente Por Fecha / Por Familia Espesor y Ancho</h4></div>
                <div class="panel-body">                
                    <div class="input-group">
                    <asp:Chart ID="Chart4" runat="server"  BackColor="0, 51, 102" 
            BackGradientStyle="Center" Palette="SeaGreen" Width="450px" OnClick="Chart4_Click" Height="400px">
            ...
            <Titles>
                <asp:Title BackColor="#003366" ForeColor="White" Name="Title1" 
                    Text="Pendiente Por Fecha">
                        ...
                        <div style="overflow:auto; width:400px;   float: right; height: 400px;">
                    ...
                    <%--<HeaderStyle BackColor="#337ab7" Font-Bold="True" ForeColor="White" />--%>
                        ...
                        <Columns>
                            <asp:ButtonField CommandName="Ver" HeaderText="Ver" ButtonType="Button" Text="Ver" >            
                            </asp:ButtonField>
                            ...
                            <asp:BoundField DataField="Cantidad_Pendiente" HeaderText="Pendiente" DataFormatString="{0:0.00}">
                            <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
