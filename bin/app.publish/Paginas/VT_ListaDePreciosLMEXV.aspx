<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="VT_ListaDePreciosLMEXV.aspx.cs" Inherits="SintecromNet.Paginas.VT_ListaDePreciosLMEXV" %>
    ...
    <div class="jumbotron">
         <div class="panel panel-primary">
            <div class="panel-heading"><h4>Filtros</h4></div>
               ...
               <br />  <br /> 
               <asp:Label ID="lblPedido8" runat="server"  CssClass="form-control" BackColor="#337AB7" ForeColor="White" style="text-align: left" Text="Aleación:" Width="140px"></asp:Label>
...
<br />
        ...
        <Columns>
            ...
            <asp:BoundField DataField="LME" HeaderText="LME" DataFormatString="{0:n3}" />           
            <asp:BoundField DataField="PrecioTransf" HeaderText="Precio Transf" DataFormatString="{0:n3}" />           
            <asp:BoundField DataField="TotalPrecio" HeaderText="Total Neto" DataFormatString="{0:n3}" />           
