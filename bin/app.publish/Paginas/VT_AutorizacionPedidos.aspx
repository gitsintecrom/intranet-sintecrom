<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="VT_AutorizacionPedidos.aspx.cs" Inherits="SintecromNet.Paginas.VT_AutorizacionPedidos" %>
    ...
    <div class="jumbotron">
        ...
        <asp:GridView ID="gwGrilla" runat="server" AutoGenerateColumns="False" 
         CssClass="table table-striped table-bordered table-hover"  
                    ...
                    EmptyDataText="No se Encontraron Datos" OnRowCommand="gwGrilla_RowCommand" DataKeyNames="Pedido,ID,Flag_ID,OTE,IDPedido,VERIFICACION">
        <Columns>
