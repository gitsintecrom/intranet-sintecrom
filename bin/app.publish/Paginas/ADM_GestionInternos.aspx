<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ADM_GestionInternos.aspx.cs" Inherits="SintecromNet.Paginas.ADM_GestionInternos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <div class="jumbotron">
    <h2>Gestión Internos Telefónicos</h2><asp:ScriptManager ID="ScriptManager1" runat="server">
        </asp:ScriptManager>

        <div class="panel-body">
                <h4><asp:Button ID="btnAgregar" runat="server" class="btn btn-success btn-circle" Text="+" Font-Bold="True" Font-Size="Medium" OnClick="btnAgregar_Click"/>&nbsp;Agregar Un Nuevo Interno</h4></div>
...
<ControlStyle BorderStyle="None" CssClass="btn btn-danger"></ControlStyle>
        ...
        <asp:Panel ID="Panel1" runat="server" Visible="False">
            ...
            <div class="panel-heading"><h4>Nuevo Interno</h4></div>
                <div class="panel-body">                
                    <div class="input-group">
            ...
            <br />   
            <br /> 
            <asp:Label ID="Label2" runat="server" BackColor="#337AB7" CssClass="form-control" ForeColor="White" Text="Interno:" Width="150px"></asp:Label>
            <asp:TextBox ID="txtInterno" cssclass="form-control" runat="server" Width="300px"></asp:TextBox>           
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="El Campo Empresa No puede Estar Vacio" ControlToValidate="txtInterno" ValidationGroup="Aceptar" CssClass="alert-danger">*</asp:RequiredFieldValidator>
            <br />   
            <br /> 
            <asp:Label ID="Label5" runat="server" BackColor="#337AB7" CssClass="form-control" ForeColor="White" Text="Sector:" Width="150px"></asp:Label>
            <asp:TextBox ID="txtSector" cssclass="form-control" runat="server" Width="300px"></asp:TextBox>   
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="El Campo Sector No Puede Estar Vacío" ControlToValidate="txtSector" ValidationGroup="Aceptar" CssClass="alert-danger">*</asp:RequiredFieldValidator>
