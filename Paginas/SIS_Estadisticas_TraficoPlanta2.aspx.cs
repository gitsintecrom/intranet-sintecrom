...
{
    public partial class SIS_Estadisticas_TraficoPlanta2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    string str;
                    str = "window.open('http://10.0.0.2/graphs/iface/ether1-WAN/','Titulo','width=500,height=500,sc rollbars=no,resizable=no')";
