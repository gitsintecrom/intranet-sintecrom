...
{
    public partial class ADM_SaldosPorCliente : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    this.ConsolidoSaldos("SP_ConsolidoSaldosClientes");
                    this.TraerGrilla(gwGrilla, "SP_TraerSaldosClientes");
        ...
        private void ConsolidoSaldos(string nombreSP)
        {
            Clases.AccesoDatos unAcceso = new Clases.AccesoDatos("SintecromNet");
        ...
        protected void btnExcel_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Page.Response.AddHeader("Content-Disposition", "attachment; filename=Saldos.xls");
