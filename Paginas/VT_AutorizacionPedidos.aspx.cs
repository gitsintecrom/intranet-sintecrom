...
{
    public partial class VT_AutorizacionPedidos : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    this.TraerGrilla(gwGrilla, "dbo.SP_VT_AutorizarPedidoCabecera");
                }
            }
        ...
        private void InsertarDatos(string nombreSP, int iRespuesta)
        {
            ...
            try
            {
                ...
                unosParametros[0] = new SqlParameter("@Pedido_ID", System.Data.SqlDbType.VarChar);
                unosParametros[0].Value = Session["IDPedido"].ToString();  
        ...
        {
            int iRespuesta = 1;
            this.InsertarDatos("SP_VT_InsertarAutorizacionesPedidos", iRespuesta);
            this.TraerGrilla(gwGrilla, "dbo.SP_VT_AutorizarPedidoCabecera");
