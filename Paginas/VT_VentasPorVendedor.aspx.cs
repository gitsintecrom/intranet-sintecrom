...
{
    public partial class VT_VentasPorVendedor : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //{
                ...
                {
                    this.TraerVentas("dbo.SP_TraerVentasPorClienteXV");
        ...
        private void TraerVentas(string nombreStored)
        {
            ...
            try
            {
                ...
                Chart4.Series["Series1"].XValueMember = "Denominacion";
        ...
        private void TraerVentasPorClientes(string nombreStored, string Cliente)
        {
            Clases.AccesoDatos unAcceso = new Clases.AccesoDatos("SintecromNet");
            SqlParameter[] unosParametros = null;
            DataSet unDS = null;
        ...
        protected void Chart4_Click(object sender, ImageMapEventArgs e)
        {
            ...
            this.TraerVentasPorClientes("dbo.SP_TraerDetalleVentasPorClienteXV", sCliente);
