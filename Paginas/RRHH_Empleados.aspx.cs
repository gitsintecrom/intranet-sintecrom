...
{
    public partial class RRHH_Empleados : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    this.TraerGrilla(gwGrilla, "dbo.SP_I_TraerEmpleadosCuenta");
        ...
        protected void btnExcel_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Page.Response.AddHeader("Content-Disposition", "attachment; filename= Empleados.xls");
