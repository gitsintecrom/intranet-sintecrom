<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="VT_VentasPorVendedor.aspx.cs" Inherits="SintecromNet.Paginas.VT_VentasPorVendedor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <h2>Ventas <asp:Label ID="Label1" runat="server"></asp:Label></h2>

        <div class="panel panel-primary">
            <div class="panel-heading"><h4>Ventas Por Cliente En Dolares</h4></div>
        ...
        <div class="panel panel-primary">
            <div class="panel-heading"><h4>Ventas Cliente: <asp:Label ID="lblTitulo" runat="server"></asp:Label></h4></div>
                <div class="panel-body">                
                    <div class="input-group">
                      <br />  
