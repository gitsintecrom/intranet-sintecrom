...
{
    public partial class PROD_SeguimientoPedidosFabricados : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    this.ActualizarCumplimiento("xSp_I_Estado_cartera_pedidos6M");
        ...
        private void CargarComboFamilia()
        {
            ...
            try
            {
                ...
                unDS = unAcceso.ExecuteDataSet(new SqlCommand("dbo.SP_PROD_TraerComboFamilia"));

                ddFamilia.DataSource = unDS;
                ddFamilia.DataValueField = "Descripcion";
        ...
        private void TraerCartera(GridView unGrid, string nombreStored)
        {
            ...
            try
            {
                ...
                unosParametros[3] = new SqlParameter("@Numero", System.Data.SqlDbType.VarChar);
                unosParametros[3].Value = txtNumeroPedido.Text;

                unosParametros[4] = new SqlParameter("@Demora", System.Data.SqlDbType.VarChar);
                unosParametros[4].Value = DropDownList1.SelectedValue;

                unosParametros[5] = new SqlParameter("@Familia", System.Data.SqlDbType.VarChar);
                unosParametros[5].Value = ddFamilia.SelectedValue;
        ...
        protected void ButtonVer_Click(object sender, EventArgs e)
        {
            ...
            this.TraerCartera(gwNoCumplidos,  "dbo.SP_PROD_ControlFechaEntrega");
        ...
        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            ...
            Page.Response.AddHeader("Content-Disposition", "attachment; filename= SeguimientoEntregaPedidos.xls");
