...
namespace SintecromNet.Paginas
{
    ...
    public partial class VT_ListaDePreciosLMEXV : System.Web.UI.Page
    {
        ...
        private void TraerGrilla(GridView unGrid, string nombreStored)
        {
            ...
            try
            {
                ...
                unosParametros[1].Value = ddAleacion.SelectedValue;
                ...
                unosParametros[4] = new SqlParameter("@LME", System.Data.SqlDbType.Decimal);
                unosParametros[4].Value = ( Session["dvalor"]);

                unosParametros[5] = new SqlParameter("@Vendedor", System.Data.SqlDbType.VarChar);

                if ((Session["Vendedor"] == null))
                {
                    unosParametros[5].Value = "";
                }
                else
                {
                    unosParametros[5].Value = Session["Vendedor"].ToString();
                }
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            this.TraerGrilla(gwGrilla, "dbo.SP_VT_TraerListadePreciosLME");
        ...
        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            ...
            Page.Response.AddHeader("Content-Disposition", "attachment; filename= ListaLME.xls");
