...
{
    public partial class PROD_AjusteInventarioSRP : System.Web.UI.Page
    {        
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach (IdentityReference i in irc)
            {
                ...
                if (group == "DOMINIOW_SISTEMAS" || group == "DOMINIOW_SUPPLYCHAIN" || group == "DOMINIOW_DIRECCION" || group == "DOMINIOW_ADMINISTRACION" || group == "DOMINIOW_VENTAS" || group == "DOMINIOW_PRODUCCION")
                {
        ...
        private void TraerAjustes(string nombreStored)
        {
            ...
            try
            {
                ...
                unosParametros[2].Value = txtSerie.Text;
          ...
          protected void ButtonVer_Click(object sender, EventArgs e)
        {
            ...
            this.TraerAjustes("dbo.SP_I_TraerAjustesInventarioSRP");
                    
        }

        protected void btnExcel_Click(object sender, ImageClickEventArgs e)
        {
            string nombre = "Ajustes";
