...
{
    public partial class ADM_Pendientes_Por_Cliente : System.Web.UI.Page
    {
        ...
        protected void btnExcel_Click(object sender, ImageClickEventArgs e)
        {
            ...
            gwPendientes.EnableViewState = false;
            page.EnableEventValidation = false;
            page.DesignerInitialize();
            page.Controls.Add(form);
            form.Controls.Add(gwPendientes);
            ...
            Page.Response.AddHeader("Content-Disposition", "attachment; filename= PendientesClientes.xls");
            Page.Response.Charset = "UTF-8";
            Page.Response.ContentEncoding = Encoding.Default;
            Page.Response.Write(sb.ToString());
            Page.Response.End();
            gwPendientes.Visible = false;
        }
    }
}