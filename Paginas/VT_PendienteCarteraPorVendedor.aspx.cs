...
{
    public partial class VT_PendienteCarteraPorVendedor : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.TraerDataSet("dbo.SP_PedidosFabricadosXV");
                this.TraerDetalle("SP_DetallePedidosFabricadosXV");
        ...
        private void TraerDataSet(string nombreStored)
        {
            ...
            try
            {
                ...
                Chart4.Series["Series1"].XValueMember = "razonsocial";
                Chart4.Series["Series1"].YValueMembers = "fabricado";
        ...
        private void TraerDetalleDataSet(string nombreStored, string Cliente)
        {
            Clases.AccesoDatos unAcceso = new Clases.AccesoDatos("SintecromNet");
            SqlParameter[] unosParametros = null;
            DataSet unDS = null;
        ...
        protected void Chart4_Click(object sender, ImageMapEventArgs e)
        {
            ...
            lblTitulo.Text = sCliente;
            this.TraerDetalleDataSet("dbo.SP_DetallePedidosFabricadosXCliXV", sCliente);
        ...
        protected void btnExcel_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Page.Response.AddHeader("Content-Disposition", "attachment; filename= CarteraPorCliente.xls");
