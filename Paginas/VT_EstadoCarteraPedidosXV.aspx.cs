...
{
    public partial class VT_EstadoCarteraPedidosXV : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                else
                {
                    ...
                    this.ActualizarCumplimiento("xSp_I_Estado_cartera_pedidos");
                     Label38.Text = Session["Vendedor"].ToString();
                }
        ...
        private void TraerCartera(GridView unGrid, GridView DosGrid, string nombreStored)
        {
            ...
            try
            {
                ...
                unosParametros[1].Value = Session["Vendedor"].ToString().Trim();
