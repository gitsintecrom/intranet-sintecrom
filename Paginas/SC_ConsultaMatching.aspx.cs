...
{
    public partial class SC_ConsultaMatching : System.Web.UI.Page
    {
        ...
        private void TraerGrilla(GridView unGrid, string nombreStored)
        {
            ...
            try
            {
                ...
                unosParametros[0].Value = Convert.ToInt32(txtNumero.Text);
        ...
        {
            this.TraerGrilla(gwGrilla, "dbo.SP_SC_ConsultaMatchingsCabecera");
