...
{
    public partial class SIS_Consultores : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    this.TraerDatos(gwGrilla, "dbo.SIS_TraerConsultores");
                }
        ...
        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            ...
            Page.Response.AddHeader("Content-Disposition", "attachment; filename= FacturacionConsultores.xls");
