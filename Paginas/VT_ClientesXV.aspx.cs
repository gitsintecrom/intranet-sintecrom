...
{
    public partial class VT_ClientesXV : System.Web.UI.Page
    {
        decimal dKilos = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    this.TraerGrilla(gwGrilla, "dbo.SP_VT_TraerClienteXV");
                }
        ...
        private void TraerGrilla(GridView unGrid, string nombreStored)
        {
            ...
            try
            {
                ...
                unosParametros[0].Value = Session["Vendedor"].ToString();
