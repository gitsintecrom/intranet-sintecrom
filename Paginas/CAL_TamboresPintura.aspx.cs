...
{
    public partial class CAL_TamboresPintura : System.Web.UI.Page
    {
        ...
        private void TraerGrilla(GridView unGrid, string nombreStored)
        {
            ...
            try
            {
                ...
                unosParametros[2] = new SqlParameter("@DescProd", System.Data.SqlDbType.VarChar);
                unosParametros[2].Value = txtProducto.Text;

                unosParametros[3] = new SqlParameter("@Cliente", System.Data.SqlDbType.VarChar);
                unosParametros[3].Value = txtCliente.Text;
        ...
        protected void btnExcel_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Page.Response.AddHeader("Content-Disposition", "attachment; filename= RegistracionTambores.xls");
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            this.TraerGrilla(gwGrilla, "SP_CAL_TraeRegistracionTambores");
