...
{
    public partial class VT_MateriasPrimasPendientes : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.TraerPendientePorFamilia("dbo.SP_TraerOCPendientesPorFamiliaEspesor");
        ...
        private void TraerDetallePorFamilia(string nombreStored)
        {
            ...
            try
            {
                ...
                unosParametros[2] = new SqlParameter("@Ancho", System.Data.SqlDbType.VarChar);
                unosParametros[2].Value = Session["Ancho"].ToString().Trim();
                unAcceso.AbrirConexion();
                unDS = unAcceso.ExecuteDataSet(new SqlCommand(nombreStored), unosParametros);
        ...
        private void TraerGraficoPorFamilia(string nombreStored)
        {
            Clases.AccesoDatos unAcceso = new Clases.AccesoDatos("SintecromNet");
            SqlParameter[] unosParametros = null;
            DataSet unDS = null;
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Ver")
            {
                ...
                Session["Ancho"] = this.GridView1.Rows[index].Cells[5].Text.ToString();



                this.TraerDetallePorFamilia("SP_TraerDetalleOCPendientesPorFamiliaEspesor");
                this.TraerGraficoPorFamilia("SP_TraerOCPendientesPorFechaPorFamila");
