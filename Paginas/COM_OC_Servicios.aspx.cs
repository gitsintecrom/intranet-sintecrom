...
{
    public partial class COM_OC_Servicios : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                foreach (IdentityReference i in irc)
                {
                    ...
                    if (group == "DOMINIOW_SISTEMAS" || group == "DOMINIOW_COMPRAS" || group == "DOMINIOW_GERENTES" || group == "DOMINIOW_ADMINISTRACION")
                    {
                ...
                {
                    this.TraerOC_Servicios(gwOCServicios, "dbo.SP_I_TraerOrdenesDeComprasServicios");
                }
        ...
        private void ActualizarDatos(string nombreSP)
        {
            ...
            try
            {
                ...
                unosParametros[1].Value = txtPorcentaje.Text;//.Replace(",", ".");
