...
{
    public partial class INV_EgresoInventario : System.Web.UI.Page
    {
        ...
        private void InsertarDatos(string nombreSP)
        {
            ...
            try
            {
                ...
                unosParametros[5] = new SqlParameter("@Detalle", System.Data.SqlDbType.VarChar);
                unosParametros[5].Value = txtDetalle.Text;               
        ...
        {
            this.InsertarDatos("dbo.SP_INV_InsertarTREgresoInventario");
            Panel1.Visible = false;
            Panel2.Visible = false;
        }
