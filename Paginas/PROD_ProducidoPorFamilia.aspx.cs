...
{
    public partial class PROD_ProducidoPorFamilia : System.Web.UI.Page
    {
        ...
        private void TraerGrilla(GridView unGrid, string nombreStored)
        {
            ...
            try
            {
                ...
                unosParametros[3] = new SqlParameter("@Pintado", System.Data.SqlDbType.VarChar);
                unosParametros[3].Value = ddPintado.SelectedValue;
        ...
        protected void btnExcel_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Page.Response.AddHeader("Content-Disposition", "attachment; filename= ProducidoPorFamilia.xls");
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            this.TraerGrilla(gwGrilla, "SP_PROD_TraerProducido");
