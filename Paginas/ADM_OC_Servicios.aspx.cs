...
namespace SintecromNet.Paginas
{
    public partial class ADM_OC_Servicios : System.Web.UI.Page
    {
        ...
        protected void btnExcel_Click1(object sender, ImageClickEventArgs e)
        {
            ...
            gwOCServicios.EnableViewState = false;
            page.EnableEventValidation = false;
            page.DesignerInitialize();
            page.Controls.Add(form);
            form.Controls.Add(gwOCServicios);
            ...
            Page.Response.AddHeader("Content-Disposition", "attachment; filename= OCServicios.xls");
            Page.Response.Charset = "UTF-8";
            Page.Response.ContentEncoding = Encoding.Default;
            Page.Response.Write(sb.ToString());
            Page.Response.End();
            gwOCServicios.Visible = false;
        }
