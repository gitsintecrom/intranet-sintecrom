<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="INV_InventarioTambores.aspx.cs" Inherits="SintecromNet.Paginas.INV_InventarioTambores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    <h2>Inventario Tambores de Pintura</h2>
    ...
    <div class="jumbotron">
         <div class="panel panel-primary">
            <div class="panel-heading"><h4>Filtros</h4></div>
                ...
                &nbsp;&nbsp;
                <asp:Label ID="lblPedido5" runat="server"  CssClass="form-control" BackColor="#337AB7" ForeColor="White" style="text-align: left" Text="Serie/Lote:" Width="120px"></asp:Label>
                <asp:TextBox ID="txtBSerie" runat="server" CssClass="form-control"  Width="120px"></asp:TextBox>
                <%--<br />  <br />--%>
                <asp:Label ID="lblPedido6" runat="server"  CssClass="form-control" BackColor="#337AB7" ForeColor="White" style="text-align: left" Text="Cod.Producto:" Width="120px"></asp:Label>
                <asp:TextBox ID="txtProducto" runat="server" CssClass="form-control"  Width="120px"></asp:TextBox>
                <%--<br />--%>
                        <asp:Label ID="lblPedido7" runat="server"  CssClass="form-control" BackColor="#337AB7" ForeColor="White" style="text-align: left" Text="Des.Producto:" Width="120px"></asp:Label>
                <asp:TextBox ID="txtDesProducto" runat="server" CssClass="form-control"  Width="120px"></asp:TextBox>
               
          <%-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--%>
               
            <asp:Button ID="btnVer0" runat="server" cssclass="btn btn-success btn-circle" onclick="ButtonVer_Click" TabIndex="50" Text="Buscar" Width="120px" />
