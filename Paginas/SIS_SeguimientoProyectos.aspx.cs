...
{
    public partial class SIS_SeguimientoProyectos : System.Web.UI.Page
    {
        ...
        private void TraerDatos(GridView unGrid, string nombreStored)
        {
            ...
            try
            {
                ...
                unosParametros[2] = new SqlParameter("@Estado", System.Data.SqlDbType.Int);
        ...
        protected void ButtonVer_Click(object sender, EventArgs e)
        {
            ...
            this.TraerDatos(gwGrilla, "dbo.SIS_SeguimientoProyectos");
        ...
        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            ...
            Page.Response.AddHeader("Content-Disposition", "attachment; filename= SeguimientoProyectos.xls");
        ...
        protected void gwGrilla_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                if (e.Row.Cells[9].Text == "En Proceso")
                {
                    ...
                    //e.Row.Cells[9].Text = "<img src='/images/advertencia.png' width=10px height=10px border=0 style='backcolor:#000000'>" + e.Row.Cells[9].Text;
                }
                else if (e.Row.Cells[9].Text == "Pendiente")
                {
                    e.Row.BackColor = System.Drawing.Color.DarkOrange;
                    e.Row.ForeColor = System.Drawing.Color.White;
                }
                else if (e.Row.Cells[9].Text == "Descartado")
                {
                    e.Row.BackColor = System.Drawing.Color.DarkRed;
                    e.Row.ForeColor = System.Drawing.Color.White;
                }
                else if (e.Row.Cells[9].Text == "Realizado")
                {
