...
{
    public partial class VT_DetalleAutorizacionMatching : System.Web.UI.Page
    {
        ...
        private void TraerGrilla(GridView unGrid, string nombreStored)
        {
            ...
            try
            {
                ...
                unosParametros[2] = new SqlParameter("@Dictamen", System.Data.SqlDbType.Int);
        ...
        {
            this.TraerGrilla(gwGrilla, "dbo.SP_VT_TraerDictamenAutorizacionesMatching");
            LinkButton3.Visible = true;
            gwGrilla.Visible = true;
        }
        ...
        protected void LinkButton3_Click(object sender, EventArgs e)
        {
            ...
            Page.Response.AddHeader("Content-Disposition", "attachment; filename= DictamenMatching.xls");
