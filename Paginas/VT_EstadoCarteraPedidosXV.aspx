<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="VT_EstadoCarteraPedidosXV.aspx.cs" Inherits="SintecromNet.Paginas.VT_EstadoCarteraPedidosXV" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
    ...
    <div class="jumbotron">
    <h2>Estado Cartera de Pedidos <asp:Label ID="Label38" runat="server"></asp:Label> </h2>    
        ...
        <div class="panel panel-primary">
            <div class="panel-heading"><h4>Filtros</h4></div>
                ...
                <asp:Label ID="Label2" runat="server" CssClass="form-control" BackColor="#337AB7" ForeColor="White" style="text-align: left" Text="Cliente:" Width="80px"></asp:Label>
                <asp:TextBox ID="txtCliente" runat="server" CssClass="form-control" Width="150px"></asp:TextBox>
                &nbsp; 
                         
                         <asp:Label ID="lblPedido" runat="server" CssClass="form-control" BackColor="#337AB7" ForeColor="White" style="text-align: left; top: 0px; left: 0px;" Text="Pedido:" Width="80px"></asp:Label>
                        <asp:TextBox ID="txtNumeroPedido" runat="server" CssClass="form-control" Width="150px"></asp:TextBox>                
                        <br /><br />
                        <asp:Label ID="lblPedido0" runat="server" CssClass="form-control" BackColor="#337AB7" ForeColor="White" style="text-align: left; top: 0px; left: 0px;" Text="Estado:" Width="80px"></asp:Label>
                         
                        <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" Width="150px">
                                <asp:ListItem Value="Todos">Todos</asp:ListItem>
                                <asp:ListItem Value="F" Selected="True">Pendiente</asp:ListItem>
                                <asp:ListItem Value="T">Cumplido</asp:ListItem>
                                </asp:DropDownList>
                        
            <asp:Label ID="Label22" runat="server" CssClass="form-control" BackColor="#337AB7" ForeColor="White" style="text-align: left" Text="Días Rango:" Width="150px"></asp:Label>
            <asp:TextBox ID="txtDias" runat="server" CssClass="form-control" Width="80px" TextMode="Number">90</asp:TextBox> 
                        &nbsp;
...
<asp:ImageButton ID="btnExcel" runat="server" CssClass="form-control" Height="51px" 
    ...
    ToolTip="Exportar a Excel" Width="53px" Visible="False" ImageAlign="Middle" />
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Orden_Compra" HeaderText="Orden Compra" >            
            </asp:BoundField>
            ...
            <asp:BoundField DataField="Cancelado" DataFormatString="{0:n0}" HeaderText="Cancelado" />
            <asp:BoundField DataField="Transferido" DataFormatString="{0:n0}" HeaderText="Transferido" />


            <asp:ButtonField CommandName="aProgramar"  DataTextField="aProgramar" 
                HeaderText="A Programar" ButtonType="Button"  DataTextFormatString="{0:n0}" ControlStyle-BorderStyle="None" ControlStyle-CssClass="btn btn-primary" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">            
...
<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
             ...
             <asp:ButtonField CommandName="VerEnFabrica"  DataTextField="EnFabricacion"
                HeaderText="En Fabricación" ButtonType="Button"  DataTextFormatString="{0:n0}" ControlStyle-CssClass="btn btn-info" ControlStyle-BorderStyle="None">            
<ControlStyle BorderStyle="None" CssClass="btn btn-info"></ControlStyle>
            ...
            <asp:ButtonField CommandName="Fabricado"  DataTextField="Fabricado"
                HeaderText="Pendiente de Despacho" ButtonType="Button" ControlStyle-CssClass="btn btn-warning" ControlStyle-BorderStyle="None" DataTextFormatString="{0:n0}" >            
<ControlStyle BorderStyle="None" CssClass="btn btn-warning"></ControlStyle>
             ...
             <asp:ButtonField CommandName="Entregado"  DataTextField="Entregado"
                HeaderText="Entregado" ButtonType="Button" ControlStyle-CssClass="btn btn-success" ControlStyle-BorderStyle="None" DataTextFormatString="{0:n0}" >            
