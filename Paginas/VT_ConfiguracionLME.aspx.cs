...
{
    public partial class VT_ConfiguracionLME : System.Web.UI.Page
    {
        ...
        private void GeneraLista(string nombreStored)
        {
            ...
            try
            {
                ...
                unosParametros[0] = new SqlParameter("@LME", System.Data.SqlDbType.Decimal);
                unosParametros[0].Value = (Session["dvalor"]);
        ...
        private void TraerLista(string nombreStored)
        {
            ...
            try
            {
                ...
                {
                    TraerLME("dbo.SP_VT_TraerCotizacionLME");
                    this.GeneraLista("SP_VT_GenerarListaPreciosLME");
                    this.EditarDatos("SP_VT_EditarListaPreciosNuevaLME");

                    this.TraerGrilla(gwGrilla, "SP_VT_TraerListaPreciosLME");
        ...
        private void TraerLME(string nombreStored)
        {
            Clases.AccesoDatos unAcceso = new Clases.AccesoDatos("SintecromNet");
            DataSet unDS = null;
            ...
            try
            {
                ...
                for (int i = 0; i < unDS.Tables[0].Rows.Count; i++)
                {
                    ...
                    Session["dvalor"] = unDS.Tables[0].Rows[i]["Valor"].ToString().Replace(".", ",");
        ...
        {
            this.EditarDatos("dbo.SP_VT_EditarListaPreciosLME");
            this.TraerGrilla(gwGrilla, "SP_VT_TraerListaPreciosLME");
            Div1.Visible = false;
        }
        ...
        {
            Mensaje.Visible = false;
            this.TraerLista("dbo.SP_VT_TraerListaPreciosLME");
        }
        ...
        {
            this.TraerListaParaEditar("dbo.SP_VT_TraerListaPreciosLME");
        }
