...
{
    public partial class VT_CuentaCorrienteGlobal : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                foreach (IdentityReference i in irc)
                {
                    ...
                    if (group == "DOMINIOW_SISTEMAS" || group == "DOMINIOW_DIRECCION" || group == "DOMINIOW_VENTAS" || group == "DOMINIOW_ADMINISTRACION")
                    {
