...
{
    public partial class ADM_InventarioMensualCostos : System.Web.UI.Page
    {
        decimal dKilos = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    this.TraerGrilla(gwGrilla, "SP_INV_TraerInventarioFinalMes");
                }
        ...
        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            ...
            Page.Response.AddHeader("Content-Disposition", "attachment; filename= InventarioCierreMes.xls");
