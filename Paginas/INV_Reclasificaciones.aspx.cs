...
{
    public partial class INV_Reclasificaciones : System.Web.UI.Page
    {
        //int ddKilos = 0;
        ...
        public void CargarProductosID()
        {
            ...
            try
            {
                ...
                unAcceso.AbrirConexion();
                unDS = unAcceso.ExecuteDataSet(new SqlCommand("dbo.SP_INV_TraerComboProductosID"));
        ...
        private void InsertarDatos(string nombreSP)
        {
            ...
            try
            {
                ...
                unosParametros[6].Value = Session["DEPOSITO_ID"];

                unosParametros[7] = new SqlParameter("@Detalle", System.Data.SqlDbType.VarChar);
                unosParametros[7].Value = txtDetalle.Text;               
