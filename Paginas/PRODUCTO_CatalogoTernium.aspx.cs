...
{
    public partial class PRODUCTO_CatalogoTernium : System.Web.UI.Page
    {
        ...
        private void TraerGrilla(GridView unGrid, string nombreStored)
        {
            ...
            try
            {
                ...
                unosParametros[2] = new SqlParameter("@Forma", System.Data.SqlDbType.VarChar);
                unosParametros[2].Value = ddForma.SelectedValue;

                unosParametros[3] = new SqlParameter("@Codigo", System.Data.SqlDbType.VarChar);
                unosParametros[3].Value = txtCodigo.Text;
        ...
        {
            this.TraerGrilla(gwGrilla, "dbo.SP_Producto_ActualizarCatalogo");
        ...
        private void ActualizarEstado(string nombreStored)
        {
            ...
            try
            {
                ...
                unosParametros[0] = new SqlParameter("@Producto_ID", System.Data.SqlDbType.VarChar);
                unosParametros[0].Value = Session["UDID"].ToString();

                unosParametros[1] = new SqlParameter("@Codigo", System.Data.SqlDbType.VarChar);
                unosParametros[1].Value = txtPrecio.Text.ToString();
        ...
        protected void gwGrilla_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "editar")
            {
                ...
                Session["UDID"] = (this.gwGrilla.DataKeys[index].Values[0]).ToString();
                Session["CodigoTernium"] = (this.gwGrilla.DataKeys[index].Values[1]).ToString();

                txtPrecio.Text = (this.gwGrilla.DataKeys[index].Values[1]).ToString();
        ...
        private void CargarComboFamilia()
        {
            ...
            try
            {
                ...
                unAcceso.AbrirConexion();
                unDS = unAcceso.ExecuteDataSet(new SqlCommand("dbo.SP_CAL_TraerComboFamilia"));
        ...
        private void CargarComboEspesor()
        {
            ...
            try
            {
                ...
                unAcceso.AbrirConexion();
                unDS = unAcceso.ExecuteDataSet(new SqlCommand("dbo.SP_CAL_TraerComboEspesor"));
        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            {
                this.ActualizarEstado("dbo.SP_PRODUCTO_EditarCatalogoTernium");
