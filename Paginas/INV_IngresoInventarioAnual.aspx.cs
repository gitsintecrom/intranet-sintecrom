...
{
    public partial class INV_IngresoInventarioAnual : System.Web.UI.Page
    {
        ...
        private void TraerDatos(string nombreStored)
        {
            ...
            try
            {
                ...
                {
                    lblKilos.BackColor = Color.Red;
                    lblKilos.Text = "No existe en el Sistema La Serie: " + txtSerie.Text + " Lote: " + txtLote.Text;
        ...
        private void TraerEtiqueta(string nombreStored)
        {
            Clases.AccesoDatos unAcceso = new Clases.AccesoDatos("SintecromNet");
            DataSet unDS = null;
            ...
            try
            {
                ...
                unosParametros[0].Value = Convert.ToInt32(txtEtiqueta.Text);
                ...
                unDS = unAcceso.ExecuteDataSet(new SqlCommand(nombreStored), unosParametros);
                 ...
                 if (dt.Rows.Count > 0)
                 {
                     Response.Write("<script>window.alert('El Número de Etiqueta ya fue Ingresado');</script>");
                     txtEtiqueta.Text = "0";
                     txtEtiqueta.Focus();
                 ...
                 else
                 {
                     ...
                     this.TraerLoteIngresado("SP_INV_TraerEtiquetasXSL");
                 }
        ...
        private void InsertarDatos(string nombreSP)
        {
            ...
            try
            {
                ...
                unosParametros[15] = new SqlParameter("@Nota", System.Data.SqlDbType.VarChar);
                unosParametros[15].Value = Session["ProdEstado"].ToString();
        ...
        {
            this.TraerEtiqueta("SP_INV_TraerEtiquetas");       
        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
           if(Session["Modifica"].ToString() == "SI")
           {
            ...
            this.InsertarDatos("SP_InsertarEtiquetas");
            this.LimpiarCampos();
        }
    }
}