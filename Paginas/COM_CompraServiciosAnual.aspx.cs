...
{
    public partial class COM_CompraServiciosAnual : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.TraerGrilla(gwGrilla, "dbo.SP_COM_TraerComprasServiciosAnuales");
        ...
        protected void btnExcel_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Page.Response.AddHeader("Content-Disposition", "attachment; filename= ComprasServiciosAnual.xls");
        ...
        protected void gwGrilla_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Detalle")
            {
                ...
                this.TraerGrillaDetalle(GridView1, "dbo.SP_COM_TraerDetalleComprasServiciosAnuales");
                gwGrilla.Visible = false;
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            Page.Response.AddHeader("Content-Disposition", "attachment; filename= DetalleComprasDetallesAnual.xls");
            Page.Response.Charset = "UTF-8";
            Page.Response.ContentEncoding = Encoding.Default;
            Page.Response.Write(sb.ToString());
            Page.Response.End();
