    ...
    {        
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                foreach (IdentityReference i in irc)
                {
                    ...
                    if (group == "DOMINIOW_SISTEMAS" || group == "DOMINIOW_SUPPLYCHAIN" || group == "DOMINIOW_GERENTES" || group == "DOMINIOW_ADMINISTRACION" || group == "DOMINIOW_VENTAS")
                    {
        ...
        private void TraerEgresos(string nombreStored)
        {
            ...
            try
            {
                ...
                unosParametros[2].Value = ddFamilia.SelectedItem.Text.ToString(); 
        ...
        private void TraerEgresosMO(string nombreStored)
        {
            ...
            try
            {
                ...
                DataTable dt = unDS.Tables[0].Copy();
                if (dt.Rows.Count > 0) btnExcel0.Visible = true;
        ...
        private void TraerEgresosCO(string nombreStored)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0) btnExcel1.Visible = true;
        ...
        private void TraerEgresosSC(string nombreStored)
        {
            ...
            try
            {
                ...
                DataTable dt = unDS.Tables[0].Copy();
                if (dt.Rows.Count > 0) btnExcel2.Visible = true;
        ...
        {
            string nombre = "Egresos";
            DataTable tabla = (DataTable)(Session["Tabla"]);

            Clases.Varias.ExportToSpreadsheet(tabla, nombre);
        }

        protected void btnExcel0_Click(object sender, ImageClickEventArgs e)
        {
            string nombre = "Mano_de_Obra";
            DataTable tabla = (DataTable)(Session["Tabla0"]);
        ...
        {
            string nombre = "Consignados";
            DataTable tabla = (DataTable)(Session["Tabla1"]);
        ...
        {
            string nombre = "Egreso_Scrap";
            DataTable tabla = (DataTable)(Session["Tabla2"]);
